 ...
 * file:///T:/software/torrent/Packt_eBooks/books/9781785880322/index.html
 */
...
// A function declared inside a class is called a method. It differs from a traditional 
// function as it can access the object properties, have visibility modifiers, and 
// can be declared static. As we will try to write code as pure as possible, our 
// properties will be of private type:
...
// declare an anonymous function and assigned it to a variable so that we can reuse 
// it later either as a parameter to another function or call it directly
$add = function(float $a, float $b): float { 
    return $a + $b; 
}; // assignment, so semicolon
$add(5, 10);
